...
router.register(r"weekly-room-templates", views.WeeklyRoomTemplateViewSet, basename="weekly-room-template")
router.register(r"expected-class-slots", views.ExpectedClassSlotViewSet, basename="expected-class-slot")
...
router.register(r"trainer-availability-raw-rows", views.TrainerAvailabilityRawRowViewSet, basename="trainer-availability-raw-row")
router.register(r"attendance-class-matches", views.AttendanceClassMatchViewSet, basename="attendance-class-match")
