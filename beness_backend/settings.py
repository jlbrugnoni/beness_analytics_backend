"""
Django settings for beness_backend project.
...
REST_FRAMEWORK = {
    ...
    "PAGE_SIZE": 15,  # Default page size for paginated APIs
}
...
ROOT_URLCONF = "beness_backend.urls"
...
WSGI_APPLICATION = "beness_backend.wsgi.application"
